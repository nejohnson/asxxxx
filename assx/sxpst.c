...
/*
 *	#define		R_5BIT	0300		No Bit Positioning
 */
...
/*
 *	#define		R_8BIT	0400		No Bit Positioning
 */
char	mode4[32] = {	/* R_8BIT */
	'\200',	'\201',	'\202',	'\203',	'\204',	'\205',	'\206',	'\207',
	'\010',	'\011',	'\012',	'\013',	'\014',	'\015',	'\016',	'\017',
	'\020',	'\021',	'\022',	'\023',	'\024',	'\025',	'\026',	'\027',
	'\030',	'\031',	'\032',	'\033',	'\034',	'\035',	'\036',	'\037'
...
/*
 *	#define		R_9BIT	0500		No Bit Positioning
 */
char	mode5[32] = {	/* R_9BIT */
	'\200',	'\201',	'\202',	'\203',	'\204',	'\205',	'\206',	'\207',
...
/*
 *	#define		R_BNK	0600		Bit Positioning
 */
char	mode6[32] = {	/* R_BNK */
	'\000',	'\001',	'\002',	'\003',	'\004',	'\005',	'\006',	'\007',
	'\200',	'\201',	'\202',	'\013',	'\014',	'\015',	'\016',	'\017',
	'\020',	'\021',	'\022',	'\023',	'\024',	'\025',	'\026',	'\027',
	'\030',	'\031',	'\032',	'\033',	'\034',	'\035',	'\036',	'\037'
};

/*
 *	#define		R_PAG	0700		Bit Positioning
 */
char	mode7[32] = {	/* R_PAG */
	'\000',	'\001',	'\002',	'\003',	'\004',	'\005',	'\006',	'\007',
	'\010',	'\200',	'\201',	'\202',	'\014',	'\015',	'\016',	'\017',
	'\020',	'\021',	'\022',	'\023',	'\024',	'\025',	'\026',	'\027',
	'\030',	'\031',	'\032',	'\033',	'\034',	'\035',	'\036',	'\037'
};

/*
 *	#define		R_SKIP	0800		Bit Positioning
 */
char	mode8[32] = {	/* R_PAG */
	'\210',	'\001',	'\002',	'\003',	'\004',	'\005',	'\006',	'\007',
	'\010',	'\011',	'\012',	'\013',	'\014',	'\015',	'\016',	'\017',
	'\020',	'\021',	'\022',	'\023',	'\024',	'\025',	'\026',	'\027',
	'\030',	'\031',	'\032',	'\033',	'\034',	'\035',	'\036',	'\037'
};
...
struct	mode	mode[9] = {
    ...
    {	&mode4[0],	0,	0x000000FF,	0x000000FF	},
    {	&mode5[0],	0,	0x000001FF,	0x000001FF	},
    {	&mode6[0],	1,	0x00000007,	0x00000700	},
    {	&mode7[0],	1,	0x00000007,	0x00000E00	},
    {	&mode8[0],	1,	0x00000100,	0x00000001	}
};
...
/*    {	NULL,	"_______",	S_CONST,	0,	VALUE	},	*/
	...
	/* SX Family Instructions */

    /* Logical Operations */
    {	NULL,	"and",		S_TYP1,		0,	0x0140	},
    {	NULL,	"not",		S_TYP2,		0,	0x0260	},
    {	NULL,	"or",		S_TYP1,		0,	0x0100	},
    {	NULL,	"xor",		S_TYP1,		0,	0x0180	},

    /* Arithmetic and Shift Operations */
    {	NULL,	"add",		S_TYP1,		0,	0x01C0	},
    {	NULL,	"clr",		S_CLR,		0,	0x0040	},
    {	NULL,	"dec",		S_TYP2,		0,	0x00E0	},
    {	NULL,	"decsz",	S_TYP2,		0,	0x02E0	},
    {	NULL,	"inc",		S_TYP2,		0,	0x02A0	},
    {	NULL,	"incsz",	S_TYP2,		0,	0x03E0	},
    {	NULL,	"rl",		S_TYP2,		0,	0x0360	},
    {	NULL,	"rr",		S_TYP2,		0,	0x0320	},
    {	NULL,	"sub",		S_TYP1,		0,	0x00A0	},
    {	NULL,	"swap",		S_TYP2,		0,	0x03A0	},

    /* Bitwise Operations */
    {	NULL,	"clrb",		S_TYP3,		0,	0x0400	},
    {	NULL,	"sb",		S_TYP3,		0,	0x0700	},
    {	NULL,	"setb",		S_TYP3,		0,	0x0500	},
    {	NULL,	"snb",		S_TYP3,		0,	0x0600	},

    /* Data Movement Instructions */
    {	NULL,	"mov",		S_MOV,		0,	0x0000	},
    {	NULL,	"movsz",	S_MOVSZ,	0,	0x02C0	},
    {	NULL,	"test",		S_TYP2,		0,	0x0220	},

    /* Program Control Instructions */
    {	NULL,	"call",		S_CALL,		0,	0x0900	},
    {	NULL,	"jmp",		S_JMP,		0,	0x0A00	},
    {	NULL,	"nop",		S_INH,		0,	0x0000	},
    {	NULL,	"ret",		S_INH,		0,	0x000C	},
    {	NULL,	"retp",		S_INH,		0,	0x000D	},
    {	NULL,	"reti",		S_INH,		0,	0x000E	},
    {	NULL,	"retiw",	S_INH,		0,	0x000F	},
    {	NULL,	"retw",		S_RETW,		0,	0x0800	},

    /* System Control Instructions */
    {	NULL,	"bank",		S_BNK,		0,	0x0018	},
    {	NULL,	"iread",	S_INH,		0,	0x0041	},
    {	NULL,	"page",		S_PAG,		0,	0x0010	},
    {	NULL,	"sleep",	S_INH,		0,	0x0003	},

    /* Defined Equivalent Instructions */
    {	NULL,	"clc",		S_INH,		0,	0x0403	},
    {	NULL,	"clz",		S_INH,		0,	0x0443	},
    {	NULL,	"mode",		S_MODE,		0,	0x0050	},
    {	NULL,	"sc",		S_SC,		0,	0x0700	},
    {	NULL,	"sz",		S_SZ,		0,	0x0700	},
    {	NULL,	"skip",		S_SKIP,		S_EOL,	0x0600	},
