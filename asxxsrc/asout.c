...
void
outrbm(struct expr *esp, int r, a_uint v)
{
	outrxbm(1, esp, r, v);
}
...
void
outr4bm(struct expr *esp, int r, a_uint v)
{
	outrxbm(4, esp, r, v);
}
...
void
outrxbm(int i, struct expr *esp, int r, a_uint v)
{
	a_uint esprv, m;
	int n, p_bytes;
	struct mode *mp;
...
void
outmode(int index, struct mode *mp)
{
	char *p;
	int i, lines;
