...
/*
 *	#define		R_4BIT	0200		Bit Positioning
 */
...
/*
 *	#define		R_5BIT	0300		Bit Positioning
 */
char	mode3[32] = {	/* R_5BIT */
...
struct	mode	mode[4] = {
    ...
    {	&mode3[0],	0,	0x0000001F,	0x0000001F	}
};
...
/*    {	NULL,	"_______",	S_CONST,	0,	VALUE	},	*/
    ...
    {	NULL,	"inc",		S_TYP1,		0,	0x20	},
    {	NULL,	"dec",		S_TYP1,		0,	0x50	},
    {	NULL,	"add",		S_TYP1,		0,	0x60	},
    {	NULL,	"sub",		S_TYP1,		0,	0x70	},

    {	NULL,	"clr",		S_TYP2,		0,	0x80	},

    {	NULL,	"lda",		S_TYP3,		0,	0xC0	},
    {	NULL,	"sta",		S_TYP3,		0,	0xE0	},

    {	NULL,	"cmp",		S_TYP4,		0,	0xB1	},
    {	NULL,	"sbc",		S_TYP4,		0,	0xB2	},
    {	NULL,	"and",		S_TYP4,		0,	0xB4	},
    {	NULL,	"eor",		S_TYP4,		0,	0xB8	},
    {	NULL,	"adc",		S_TYP4,		0,	0xB9	},
    {	NULL,	"ora",		S_TYP4,		0,	0xBA	},

    {	NULL,	"bset",		S_BIT,		0,	0x10	},
    {	NULL,	"bclr",		S_BIT,		0,	0x11	},

    {	NULL,	"brset",	S_BBIT,		0,	0x00	},
    {	NULL,	"brclr",	S_BBIT,		0,	0x01	},

    {	NULL,	"cbeq",		S_CBEQ,		0,	0x31	},
    {	NULL,	"cbeqa",	S_CBEQA,	0,	0x41	},
    {	NULL,	"cbeqx",	S_CBEQX,	0,	0x31	},

    {	NULL,	"dbnz",		S_DBNZ,		0,	0x3B	},
    {	NULL,	"dbnza",	S_DBNZA,	0,	0x4B	},
    {	NULL,	"dbnzx",	S_DBNZX,	0,	0x3B	},

    {	NULL,	"mov",		S_MOV,		0,	0x4E	},
    {	NULL,	"ldx",		S_LDX,		0,	0x4E	},
    {	NULL,	"stx",		S_STX,		0,	0x4E	},
    {	NULL,	"tst",		S_TST,		0,	0x4E	},
    {	NULL,	"tstx",		S_TSTX,		0,	0x4E	},

    {	NULL,	"bra",		S_BRA,		0,	0x30	},
    {	NULL,	"brn",		S_BRN,		0,	0x30	},
    {	NULL,	"bcc",		S_BRA,		0,	0x34	},
    {	NULL,	"bhs",		S_BRA,		0,	0x34	},
    {	NULL,	"bcs",		S_BRA,		0,	0x35	},
    {	NULL,	"blo",		S_BRA,		0,	0x35	},
    {	NULL,	"bne",		S_BRA,		0,	0x36	},
    {	NULL,	"beq",		S_BRA,		0,	0x37	},
    {	NULL,	"bsr",		S_BRA,		0,	0xAD	},

    {	NULL,	"jmp",		S_JMP,		0,	0xBC	},
    {	NULL,	"jsr",		S_JMP,		0,	0xBD	},

    {	NULL,	"clc",		S_INH,		0,	0x38	},
    {	NULL,	"sec",		S_INH,		0,	0x39	},

    {	NULL,	"sla",		S_INH,		0,	0x42	},
    {	NULL,	"coma",		S_INH,		0,	0x43	},
    {	NULL,	"lsra",		S_INH,		0,	0x44	},
    {	NULL,	"sha",		S_INH,		0,	0x45	},
    ...
    {	NULL,	"tax",		S_INH,		0,	0xEF	},
    {	NULL,	"txa",		S_INH,		0,	0xCF	},

    {	NULL,	"nop",		S_INH,		0,	0xAC	},
    {	NULL,	"stop",		S_INH,		0,	0xAE	},
    {	NULL,	"wait",		S_INH,		0,	0xAF	},

    {	NULL,	"rts",		S_INH,		0,	0xBE	},
    {	NULL,	"bgnd",		S_INH,		0,	0xBF	},

    /* Other Forms */

    {	NULL,	"sl",		S_TYP5,		0,	0x42	},
    {	NULL,	"com",		S_TYP5,		0,	0x43	},
    {	NULL,	"lsr",		S_TYP5,		0,	0x44	},
    {	NULL,	"sh",		S_TYP5,		0,	0x45	},
    {	NULL,	"ror",		S_TYP5,		0,	0x46	},
    {	NULL,	"asl",		S_TYP5,		0,	0x48	},
    {	NULL,	"lsl",		S_TYP5,		0,	0x48	},
    {	NULL,	"rol",		S_TYP5,		0,	0x49	},

    {	NULL,	"adcx",		S_INH2,		0,	0xB90F	},
    {	NULL,	"addx",		S_INH,		0,	0x6F	},
    {	NULL,	"andx",		S_INH2,		0,	0xB40F	},
    {	NULL,	"clrx",		S_INH,		0,	0x8F	},
    {	NULL,	"cmpx",		S_INH2,		0,	0xB10F	},
    {	NULL,	"decx",		S_INH,		0,	0x5F	},
    {	NULL,	"eorx",		S_INH2,		0,	0xB80F	},
    {	NULL,	"incx",		S_INH,		0,	0x2F	},
    {	NULL,	"orax",		S_INH2,		0,	0xBA0F	},
    {	NULL,	"sbcx",		S_INH2,		0,	0xB20F	},
    {	NULL,	"stax",		S_INH,		0,	0xEF	},
    {	NULL,	"ldax",		S_INH,		0,	0xCF	},
    {	NULL,	"subx",		S_INH,		0,	0x7F	},
    {	NULL,	"tsta",		S_INH2,		S_EOL,	0xAA00	}
};
