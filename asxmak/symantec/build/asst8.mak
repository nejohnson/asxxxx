...
HEADERS		= ..\..\..\ASXXSRC\asxxxx.h ..\..\..\ASST8\st8.h C:\SC\INCLUDE\stdlib.h  \
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\st8adr.OBJ  \
		 $(OUTPUTDIR)\st8mch.OBJ  $(OUTPUTDIR)\st8pst.OBJ 
...
$(OUTPUTDIR)\st8adr.OBJ:	..\..\..\ASST8\st8adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\st8adr.obj ..\..\..\ASST8\st8adr.c



$(OUTPUTDIR)\st8mch.OBJ:	..\..\..\ASST8\st8mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\st8mch.obj ..\..\..\ASST8\st8mch.c



$(OUTPUTDIR)\st8pst.OBJ:	..\..\..\ASST8\st8pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\st8pst.obj ..\..\..\ASST8\st8pst.c
