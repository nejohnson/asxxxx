...
HEADERS		= ..\..\..\ASXXSRC\asxxxx.h ..\..\..\ASST7\st7.h C:\SC\INCLUDE\stdlib.h  \
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\st7adr.OBJ  \
		 $(OUTPUTDIR)\st7mch.OBJ  $(OUTPUTDIR)\st7pst.OBJ 
...
$(OUTPUTDIR)\st7adr.OBJ:	..\..\..\ASST7\st7adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\st7adr.obj ..\..\..\ASST7\st7adr.c



$(OUTPUTDIR)\st7mch.OBJ:	..\..\..\ASST7\st7mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\st7mch.obj ..\..\..\ASST7\st7mch.c



$(OUTPUTDIR)\st7pst.OBJ:	..\..\..\ASST7\st7pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\st7pst.obj ..\..\..\ASST7\st7pst.c
