...
HEADERS		= C:\SC\INCLUDE\alloc.h ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h  \
		C:\SC\INCLUDE\stdio.h C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h ..\..\..\asolms40\ms40.h  \
		C:\SC\INCLUDE\time.h 

DEFFILE		= asolms40.DEF
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\ms40adr.OBJ  \
		 $(OUTPUTDIR)\ms40mch.OBJ  $(OUTPUTDIR)\ms40pst.OBJ 
...
!IF EXIST (asolms40.dpd)
!INCLUDE asolms40.dpd
!ENDIF
...
$(OUTPUTDIR)\ms40adr.OBJ:	..\..\..\asolms40\ms40adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\ms40adr.obj ..\..\..\asolms40\ms40adr.c



$(OUTPUTDIR)\ms40mch.OBJ:	..\..\..\asolms40\ms40mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\ms40mch.obj ..\..\..\asolms40\ms40mch.c



$(OUTPUTDIR)\ms40pst.OBJ:	..\..\..\asolms40\ms40pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\ms40pst.obj ..\..\..\asolms40\ms40pst.c
