...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\time.h ..\..\..\AS89LP\at89.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\at89adr.OBJ  \
		 $(OUTPUTDIR)\at89mch.OBJ  $(OUTPUTDIR)\at89pst.OBJ 
...
$(OUTPUTDIR)\at89adr.OBJ:	..\..\..\AS89LP\at89adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\at89adr.obj ..\..\..\AS89LP\at89adr.c



$(OUTPUTDIR)\at89mch.OBJ:	..\..\..\AS89LP\at89mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\at89mch.obj ..\..\..\AS89LP\at89mch.c



$(OUTPUTDIR)\at89pst.OBJ:	..\..\..\AS89LP\at89pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\at89pst.obj ..\..\..\AS89LP\at89pst.c
