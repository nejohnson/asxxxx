...
HEADERS		= ..\..\..\ASEZ8\ez8.h ..\..\..\ASXXSRC\asxxxx.h C:\SC\INCLUDE\stdlib.h  \
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\ez8adr.OBJ  \
		 $(OUTPUTDIR)\ez8mch.OBJ  $(OUTPUTDIR)\ez8pst.OBJ 
...
$(OUTPUTDIR)\ez8adr.OBJ:	..\..\..\ASEZ8\ez8adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\ez8adr.obj ..\..\..\ASEZ8\ez8adr.c



$(OUTPUTDIR)\ez8mch.OBJ:	..\..\..\ASEZ8\ez8mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\ez8mch.obj ..\..\..\ASEZ8\ez8mch.c



$(OUTPUTDIR)\ez8pst.OBJ:	..\..\..\ASEZ8\ez8pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\ez8pst.obj ..\..\..\ASEZ8\ez8pst.c
