...
HEADERS		= ..\..\..\ASXXSRC\asxxxx.h ..\..\..\ASST6\st6.h C:\SC\INCLUDE\stdlib.h  \
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\st6adr.OBJ  \
		 $(OUTPUTDIR)\st6mch.OBJ  $(OUTPUTDIR)\st6pst.OBJ 
...
$(OUTPUTDIR)\st6adr.OBJ:	..\..\..\ASST6\st6adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\st6adr.obj ..\..\..\ASST6\st6adr.c



$(OUTPUTDIR)\st6mch.OBJ:	..\..\..\ASST6\st6mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\st6mch.obj ..\..\..\ASST6\st6mch.c



$(OUTPUTDIR)\st6pst.OBJ:	..\..\..\ASST6\st6pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\st6pst.obj ..\..\..\ASST6\st6pst.c
