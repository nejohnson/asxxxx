...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\t90adr.OBJ  \
		 $(OUTPUTDIR)\t90mch.OBJ  $(OUTPUTDIR)\t90pst.OBJ 
...
!IF EXIST (astlcs90.dpd)
!INCLUDE astlcs90.dpd
!ENDIF
...
$(OUTPUTDIR)\t90adr.OBJ:	..\..\..\ASTLCS90\t90adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\t90adr.obj ..\..\..\ASTLCS90\t90adr.c



$(OUTPUTDIR)\t90mch.OBJ:	..\..\..\ASTLCS90\t90mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\t90mch.obj ..\..\..\ASTLCS90\t90mch.c



$(OUTPUTDIR)\t90pst.OBJ:	..\..\..\ASTLCS90\t90pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\t90pst.obj ..\..\..\ASTLCS90\t90pst.c
