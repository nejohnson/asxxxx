...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\time.h ..\..\..\ASST9\st9.h 
...
CFLAGS		=  -A -p -J -ml -C -o+space -S -3 -a2 -c -wx 
LFLAGS		=  /NOI /DE /PACKF
DEFINES		= 
!ELSE
OUTPUTDIR	= .
...
CFLAGS		=  -ms -o+time -3 -a2 -c 
LFLAGS		=  /DE /E /PACKF /XU
DEFINES		= 
!ENDIF
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\st9adr.OBJ  \
		 $(OUTPUTDIR)\st9mch.OBJ  $(OUTPUTDIR)\st9pst.OBJ 
...
$(OUTPUTDIR)\st9adr.OBJ:	..\..\..\ASST9\st9adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\st9adr.obj ..\..\..\ASST9\st9adr.c



$(OUTPUTDIR)\st9mch.OBJ:	..\..\..\ASST9\st9mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\st9mch.obj ..\..\..\ASST9\st9mch.c



$(OUTPUTDIR)\st9pst.OBJ:	..\..\..\ASST9\st9pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\st9pst.obj ..\..\..\ASST9\st9pst.c
