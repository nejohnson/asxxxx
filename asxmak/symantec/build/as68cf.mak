...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\time.h ..\..\..\AS68CF\m68cf.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\m68cfadr.OBJ  \
		 $(OUTPUTDIR)\m68cfmch.OBJ  $(OUTPUTDIR)\m68cfpst.OBJ  $(OUTPUTDIR)\m68cffpp.OBJ 
...
$(OUTPUTDIR)\m68cfadr.OBJ:	..\..\..\AS68CF\m68cfadr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m68cfadr.obj ..\..\..\AS68CF\m68cfadr.c



$(OUTPUTDIR)\m68cfmch.OBJ:	..\..\..\AS68CF\m68cfmch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m68cfmch.obj ..\..\..\AS68CF\m68cfmch.c



$(OUTPUTDIR)\m68cfpst.OBJ:	..\..\..\AS68CF\m68cfpst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m68cfpst.obj ..\..\..\AS68CF\m68cfpst.c



$(OUTPUTDIR)\m68cffpp.OBJ:	..\..\..\AS68CF\m68cffpp.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m68cffpp.obj ..\..\..\AS68CF\m68cffpp.c
