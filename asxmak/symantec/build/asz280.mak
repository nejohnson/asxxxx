...
HEADERS		= ..\..\..\ASXXSRC\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\time.h ..\..\..\ASZ280\z280def.h  \
		..\..\..\ASZ280\z280opcy.h ..\..\..\ASZ280\z280ops.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\z280adr.OBJ  \
		 $(OUTPUTDIR)\z280mch.OBJ  $(OUTPUTDIR)\z280pst.OBJ 
...
$(OUTPUTDIR)\z280adr.OBJ:	..\..\..\ASZ280\z280adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\z280adr.obj ..\..\..\ASZ280\z280adr.c



$(OUTPUTDIR)\z280mch.OBJ:	..\..\..\ASZ280\z280mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\z280mch.obj ..\..\..\ASZ280\z280mch.c



$(OUTPUTDIR)\z280pst.OBJ:	..\..\..\ASZ280\z280pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\z280pst.obj ..\..\..\ASZ280\z280pst.c
