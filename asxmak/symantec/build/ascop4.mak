...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\time.h ..\..\..\ASCOP4\cop4.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\cop4adr.OBJ  \
		 $(OUTPUTDIR)\cop4mch.OBJ  $(OUTPUTDIR)\cop4pst.OBJ 
...
$(OUTPUTDIR)\cop4adr.OBJ:	..\..\..\ASCOP4\cop4adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\cop4adr.obj ..\..\..\ASCOP4\cop4adr.c



$(OUTPUTDIR)\cop4mch.OBJ:	..\..\..\ASCOP4\cop4mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\cop4mch.obj ..\..\..\ASCOP4\cop4mch.c



$(OUTPUTDIR)\cop4pst.OBJ:	..\..\..\ASCOP4\cop4pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\cop4pst.obj ..\..\..\ASCOP4\cop4pst.c
