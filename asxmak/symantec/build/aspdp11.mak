...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\time.h ..\..\..\ASPDP11\pdp11.h 
...
CFLAGS		=  -A -r -J -ml -o+time -3 -a2 -c -wx 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\pdp11adr.OBJ  \
		 $(OUTPUTDIR)\pdp11cyc.OBJ  $(OUTPUTDIR)\pdp11fpp.OBJ  $(OUTPUTDIR)\pdp11mch.OBJ  $(OUTPUTDIR)\pdp11pst.OBJ 
...
$(OUTPUTDIR)\pdp11adr.OBJ:	..\..\..\ASPDP11\pdp11adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\pdp11adr.obj ..\..\..\ASPDP11\pdp11adr.c



$(OUTPUTDIR)\pdp11cyc.OBJ:	..\..\..\ASPDP11\pdp11cyc.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\pdp11cyc.obj ..\..\..\ASPDP11\pdp11cyc.c



$(OUTPUTDIR)\pdp11fpp.OBJ:	..\..\..\ASPDP11\pdp11fpp.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\pdp11fpp.obj ..\..\..\ASPDP11\pdp11fpp.c



$(OUTPUTDIR)\pdp11mch.OBJ:	..\..\..\ASPDP11\pdp11mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\pdp11mch.obj ..\..\..\ASPDP11\pdp11mch.c



$(OUTPUTDIR)\pdp11pst.OBJ:	..\..\..\ASPDP11\pdp11pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\pdp11pst.obj ..\..\..\ASPDP11\pdp11pst.c
