...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h ..\..\..\ASF8\f8.h C:\SC\INCLUDE\time.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\f8adr.OBJ  \
		 $(OUTPUTDIR)\f8mch.OBJ  $(OUTPUTDIR)\f8pst.OBJ 
...
$(OUTPUTDIR)\f8adr.OBJ:	..\..\..\ASF8\f8adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\f8adr.obj ..\..\..\ASF8\f8adr.c



$(OUTPUTDIR)\f8mch.OBJ:	..\..\..\ASF8\f8mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\f8mch.obj ..\..\..\ASF8\f8mch.c



$(OUTPUTDIR)\f8pst.OBJ:	..\..\..\ASF8\f8pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\f8pst.obj ..\..\..\ASF8\f8pst.c
