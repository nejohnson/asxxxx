...
HEADERS		= ..\..\..\ASCOP8\cop8.h ..\..\..\ASXXSRC\asxxxx.h C:\SC\INCLUDE\stdlib.h  \
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\cop8adr.OBJ  \
		 $(OUTPUTDIR)\cop8mch.OBJ  $(OUTPUTDIR)\cop8pst.OBJ 
...
$(OUTPUTDIR)\cop8adr.OBJ:	..\..\..\ASCOP8\cop8adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\cop8adr.obj ..\..\..\ASCOP8\cop8adr.c



$(OUTPUTDIR)\cop8mch.OBJ:	..\..\..\ASCOP8\cop8mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\cop8mch.obj ..\..\..\ASCOP8\cop8mch.c



$(OUTPUTDIR)\cop8pst.OBJ:	..\..\..\ASCOP8\cop8pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\cop8pst.obj ..\..\..\ASCOP8\cop8pst.c
