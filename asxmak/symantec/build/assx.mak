...
HEADERS		= ..\..\..\ASSX\sx.h ..\..\..\ASXXSRC\asxxxx.h C:\SC\INCLUDE\stdlib.h  \
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\sxadr.OBJ  \
		 $(OUTPUTDIR)\sxmch.OBJ  $(OUTPUTDIR)\sxpst.OBJ 
...
$(OUTPUTDIR)\sxadr.OBJ:	..\..\..\ASSX\sxadr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\sxadr.obj ..\..\..\ASSX\sxadr.c



$(OUTPUTDIR)\sxmch.OBJ:	..\..\..\ASSX\sxmch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\sxmch.obj ..\..\..\ASSX\sxmch.c



$(OUTPUTDIR)\sxpst.OBJ:	..\..\..\ASSX\sxpst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\sxpst.obj ..\..\..\ASSX\sxpst.c
