...
HEADERS		= C:\SC\INCLUDE\alloc.h ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h  \
		C:\SC\INCLUDE\stdio.h C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h ..\..\..\AS4040\i40.h  \
		C:\SC\INCLUDE\time.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\i40adr.OBJ  \
		 $(OUTPUTDIR)\i40mch.OBJ  $(OUTPUTDIR)\i40pst.OBJ 
...
$(OUTPUTDIR)\i40adr.OBJ:	..\..\..\AS4040\i40adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i40adr.obj ..\..\..\AS4040\i40adr.c



$(OUTPUTDIR)\i40mch.OBJ:	..\..\..\AS4040\i40mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i40mch.obj ..\..\..\AS4040\i40mch.c



$(OUTPUTDIR)\i40pst.OBJ:	..\..\..\AS4040\i40pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\i40pst.obj ..\..\..\AS4040\i40pst.c
