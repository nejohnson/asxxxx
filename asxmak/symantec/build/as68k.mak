...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\time.h ..\..\..\AS68K\m68k.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\m68kadr.OBJ  \
		 $(OUTPUTDIR)\m68kmch.OBJ  $(OUTPUTDIR)\m68kpst.OBJ  $(OUTPUTDIR)\m68kcyc.OBJ  $(OUTPUTDIR)\m68kfpp.OBJ 
...
$(OUTPUTDIR)\m68kadr.OBJ:	..\..\..\AS68K\m68kadr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m68kadr.obj ..\..\..\AS68K\m68kadr.c



$(OUTPUTDIR)\m68kmch.OBJ:	..\..\..\AS68K\m68kmch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m68kmch.obj ..\..\..\AS68K\m68kmch.c



$(OUTPUTDIR)\m68kpst.OBJ:	..\..\..\AS68K\m68kpst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m68kpst.obj ..\..\..\AS68K\m68kpst.c



$(OUTPUTDIR)\m68kcyc.OBJ:	..\..\..\AS68K\m68kcyc.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m68kcyc.obj ..\..\..\AS68K\m68kcyc.c



$(OUTPUTDIR)\m68kfpp.OBJ:	..\..\..\AS68K\m68kfpp.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m68kfpp.obj ..\..\..\AS68K\m68kfpp.c
