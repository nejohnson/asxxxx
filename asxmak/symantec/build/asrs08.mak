...
HEADERS		= ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h C:\SC\INCLUDE\stdio.h  \
		C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h C:\SC\INCLUDE\time.h ..\..\..\ASRS08\rs08.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\rs08adr.OBJ  \
		 $(OUTPUTDIR)\rs08mch.OBJ  $(OUTPUTDIR)\rs08pst.OBJ 
...
$(OUTPUTDIR)\rs08adr.OBJ:	..\..\..\ASRS08\rs08adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\rs08adr.obj ..\..\..\ASRS08\rs08adr.c



$(OUTPUTDIR)\rs08mch.OBJ:	..\..\..\ASRS08\rs08mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\rs08mch.obj ..\..\..\ASRS08\rs08mch.c



$(OUTPUTDIR)\rs08pst.OBJ:	..\..\..\ASRS08\rs08pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\rs08pst.obj ..\..\..\ASRS08\rs08pst.c
