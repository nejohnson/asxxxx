...
HEADERS		= C:\SC\INCLUDE\alloc.h ..\..\..\asxxsrc\asxxxx.h C:\SC\INCLUDE\stdlib.h  \
		C:\SC\INCLUDE\stdio.h C:\SC\INCLUDE\setjmp.h C:\SC\INCLUDE\string.h ..\..\..\AS370\m370.h  \
		C:\SC\INCLUDE\time.h 
...
OBJS		=  $(OUTPUTDIR)\asdata.OBJ  $(OUTPUTDIR)\asdbg.OBJ  $(OUTPUTDIR)\asexpr.OBJ  \
		 ...
		 $(OUTPUTDIR)\asout.OBJ  $(OUTPUTDIR)\assubr.OBJ  $(OUTPUTDIR)\assym.OBJ  $(OUTPUTDIR)\m370adr.OBJ  \
		 $(OUTPUTDIR)\m370mch.OBJ  $(OUTPUTDIR)\m370pst.OBJ 
...
$(OUTPUTDIR)\m370adr.OBJ:	..\..\..\AS370\m370adr.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m370adr.obj ..\..\..\AS370\m370adr.c



$(OUTPUTDIR)\m370mch.OBJ:	..\..\..\AS370\m370mch.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m370mch.obj ..\..\..\AS370\m370mch.c



$(OUTPUTDIR)\m370pst.OBJ:	..\..\..\AS370\m370pst.c
		$(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -o$(OUTPUTDIR)\m370pst.obj ..\..\..\AS370\m370pst.c
