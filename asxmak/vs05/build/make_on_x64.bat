...
REM SET VC$BUILD="C:\Program Files\Microsoft Visual Studio 8\VC\vcpackages\vcbuild.exe"
REM Running On A 64-Bit System
SET VC$BUILD="C:\Program Files (x86)\Microsoft Visual Studio 8\VC\vcpackages\vcbuild.exe"
REM
