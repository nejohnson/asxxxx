...
/*    {	NULL,	"_______",	S_CONST,	0,	VALUE	},	*/
    ...
    {	NULL,	"rnc",		S_INH,		0,	0x03	},
    {	NULL,	"rnz",		S_INH,		0,	0x0B	},
    {	NULL,	"rp",		S_INH,		0,	0x13	},
    {	NULL,	"rpo",		S_INH,		0,	0x1B	},
    {	NULL,	"rc",		S_INH,		0,	0x23	},
    {	NULL,	"rz",		S_INH,		0,	0x2B	},
    {	NULL,	"rm",		S_INH,		0,	0x33	},
    {	NULL,	"rpe",		S_INH,		0,	0x3B	},
    ...
    {	NULL,	"in",		S_IN,		0,	0x41	},
    {	NULL,	"out",		S_OUT,		0,	0x41	},

    {	NULL,	"adi",		S_ADI,		0,	0x04	},
    {	NULL,	"aci",		S_ADI,		0,	0x0C	},
    {	NULL,	"sui",		S_ADI,		0,	0x14	},
    {	NULL,	"sbi",		S_ADI,		0,	0x1C	},
    {	NULL,	"ani",		S_ADI,		0,	0x24	},
    {	NULL,	"xri",		S_ADI,		0,	0x2C	},
    {	NULL,	"ori",		S_ADI,		0,	0x34	},
    {	NULL,	"cpi",		S_ADI,		0,	0x3C	},

    {	NULL,	"add",		S_ADD,		0,	0x80	},
    {	NULL,	"adc",		S_ADD,		0,	0x88	},
    {	NULL,	"sub",		S_ADD,		0,	0x90	},
    {	NULL,	"sbb",		S_ADD,		0,	0x98	},
    {	NULL,	"ana",		S_ADD,		0,	0xA0	},
    {	NULL,	"xra",		S_ADD,		0,	0xA8	},
    {	NULL,	"ora",		S_ADD,		0,	0xB0	},
    {	NULL,	"cmp",		S_ADD,		0,	0xB8	},

    {	NULL,	"jmp",		S_JMP,		0,	0x44	},
    {	NULL,	"jnc",		S_JMP,		0,	0x40	},
    {	NULL,	"jnz",		S_JMP,		0,	0x48	},
    {	NULL,	"jp",		S_JMP,		0,	0x50	},
    {	NULL,	"jpo",		S_JMP,		0,	0x58	},
    {	NULL,	"jc",		S_JMP,		0,	0x60	},
    {	NULL,	"jz",		S_JMP,		0,	0x68	},
    {	NULL,	"jm",		S_JMP,		0,	0x70	},
    {	NULL,	"jpe",		S_JMP,		0,	0x78	},

    {	NULL,	"call",		S_JMP,		0,	0x46	},
    {	NULL,	"cnc",		S_JMP,		0,	0x42	},
    {	NULL,	"cnz",		S_JMP,		0,	0x4A	},
    {	NULL,	"cp",		S_JMP,		0,	0x52	},
    {	NULL,	"cpo",		S_JMP,		0,	0x5A	},
    {	NULL,	"cc",		S_JMP,		0,	0x62	},
    {	NULL,	"cz",		S_JMP,		0,	0x6A	},
    {	NULL,	"cm",		S_JMP,		0,	0x72	},
    {	NULL,	"cpe",		S_JMP,		0,	0x7A	},

    {	NULL,	"inr",		S_INR,		0,	0x00	},
    {	NULL,	"dcr",		S_INR,		0,	0x01	},

    {	NULL,	"mov",		S_MOV,		0,	0xC0	},

    {	NULL,	"mvi",		S_MVI,		S_EOL,	0x06	},
};
