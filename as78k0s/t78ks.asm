	...
	set1	a,#exbit+0			; 0Ar02
						; 0A 03
	bf	*exsfr+0xFF21,#exbit+0,.	; 0Ar04*21 FC
	xch	a,r2				; 0A 05
	set1	*exsfr+0xFF21,#exbit+0		; 0Ar06*21
	xch	a,r3				; 0A 07
	...
	set1	a,#exbit+2			; 0Ar22
						; 0A 23
	bf	*exsfr+0xFF21,#exbit+2,.	; 0Ar24*21 FC
	mov	a,r2				; 0A 25
	set1	*exsfr+0xFF21,#exbit+2		; 0Ar26*21
	mov	a,r3				; 0A 27
	...
	set1	a,#exbit+3			; 0Ar32
						; 0A 33
	bf	*exsfr+0xFF21,#exbit+3,.	; 0Ar34*21 FC
						; 0A 35
	set1	*exsfr+0xFF21,#exbit+3		; 0Ar36*21
						; 0A 37
	...
	set1	a,#exbit+5			; 0Ar52
						; 0A 53
	bf	*exsfr+0xFF21,#exbit+5,.	; 0Ar54*21 FC
						; 0A 55
	set1	*exsfr+0xFF21,#exbit+5		; 0Ar56*21
						; 0A 57
	...
	inc	r1				; 0A C3
	bt	*exsfr+0xFF21,#exbit+4,.	; 0ArC4*21 FC
	inc	r2				; 0A C5
	clr1	*exsfr+0xFF21,#exbit+4		; 0ArC6*21
	inc	r3				; 0A C7
	...
	dec	r1				; 0A D3
	bt	*exsfr+0xFF21,#exbit+5,.	; 0ArD4*21 FC
	dec	r2				; 0A D5
	clr1	*exsfr+0xFF21,#exbit+5		; 0ArD6*21
	dec	r3				; 0A D7
	...
	clr1	a,#exbit+6			; 0ArE2
						; 0A E3
	bt	*exsfr+0xFF21,#exbit+6,.	; 0ArE4*21 FC
	mov	r2,a				; 0A E5
	clr1	*exsfr+0xFF21,#exbit+6		; 0ArE6*21
	mov	r3,a				; 0A E7
	...
	bt	*exsfr+0xFF21,#exbit+7,.	; 0ArF4*21 FC
	mov	r2,#exbyt+0x45			; 0A F5r45
	clr1	*exsfr+0xFF21,#exbit+7		; 0ArF6*21
