...
/*    {	NULL,	"_______",	S_CONST,	0,	VALUE	},	*/
    ...
    {	NULL,	".regbnk",	S_RBNK,		0,	0	},

	/* AT89 MCU Types */

    {	NULL,	".lp2052",	S_AT89LP,	LP2052,	0	},
    {	NULL,	".lp213",	S_AT89LP,	LP213,	1	},
    {	NULL,	".lp214",	S_AT89LP,	LP214,	2	},
    {	NULL,	".lp216",	S_AT89LP,	LP216,	3	},
    {	NULL,	".lp3240",	S_AT89LP,	LP3240,	4	},
    {	NULL,	".lp4052",	S_AT89LP,	LP4052,	5	},
    {	NULL,	".lp428",	S_AT89LP,	LP428,	6	},
    {	NULL,	".lp51",	S_AT89LP,	LP51,	7	},
    {	NULL,	".lp51ed2",	S_AT89LP,	LP51ED2,8	},
    {	NULL,	".lp51ic2",	S_AT89LP,	LP51IC2,9	},
    {	NULL,	".lp51id2",	S_AT89LP,	LP51ID2,10	},
    {	NULL,	".lp51rb2",	S_AT89LP,	LP51RB2,11	},
    {	NULL,	".lp51rc2",	S_AT89LP,	LP51RC2,12	},
    {	NULL,	".lp51rd2",	S_AT89LP,	LP51RD2,13	},
    {	NULL,	".lp52",	S_AT89LP,	LP52,	14	},
    {	NULL,	".lp6440",	S_AT89LP,	LP6440,	15	},
    {	NULL,	".lp828",	S_AT89LP,	LP828,	16	},
    ...
    {	NULL,	"div",		S_MLDV,		0,	0x84	},
    {	NULL,	"mul",		S_MLDV,		0,	0xA4	},
    {	NULL,	"clr",		S_ACBIT,	0,	0xC2	},
    {	NULL,	"cpl",		S_ACBIT,	0,	0xB2	},
    {	NULL,	"setb",		S_SETB,		0,	0xD2	},
    {	NULL,	"push",		S_DIRECT,	0,	0xC0	},
    {	NULL,	"pop",		S_DIRECT,	0,	0xD0	},
    {	NULL,	"xchd",		S_XCHD,		0,	0xD6	},

    {	NULL,	"asr",		S_MOP,		0,	0x03	},
    {	NULL,	"lsl",		S_MOP,		0,	0x23	},
    {	NULL,	"mac",		S_MAC,		0,	0xA4	},
    {	NULL,	"break",	S_BRK,		S_EOL,	0x00	},
};
