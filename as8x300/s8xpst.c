 ...
 *
 *	#define		R_JMP	0100		---XXXXXXXXXXXXX
 */
char	mode1[32] = {	/* R_JMP */
	'\200',	'\201',	'\202',	'\203',	'\204',	'\205',	'\206',	'\207',
...
/*
 *	#define		R_VO8	0300		--XXXXXXXX------
 */
char	mode3[32] = {	/* R_VO8 */
	'\000',	'\001',	'\002',	'\003',	'\004',	'\005',	'\200',	'\201',
	'\202',	'\203',	'\204',	'\205',	'\206',	'\207',	'\016',	'\017',
	'\020',	'\021',	'\022',	'\023',	'\024',	'\025',	'\026',	'\027',
	'\030',	'\031',	'\032',	'\033',	'\034',	'\035',	'\036',	'\037'
};

/*
 *	#define		R_LO5	0400		-----------XXXXX
 */
char	mode4[32] = {	/* R_LO5 */
...
struct	mode	mode[7] = {
    ...
    {	&mode1[0],	0,	0x00001FFF,	0x00001FFF	},
    {	&mode2[0],	0,	0x000000FF,	0x000000FF	},
    {	&mode3[0],	1,	0x000000FF,	0x00003FC0	},
    {	&mode4[0],	0,	0x0000001F,	0x0000001F	},
    {	&mode5[0],	1,	0x0000001F,	0x000007C0	},
    {	&mode6[0],	1,	0x000000E0,	0x00000007	}
};
...
/*    {	NULL,	"_______",	S_CONST,	0,	VALUE	},	*/
    ...
    {	NULL,	".8x300",	S_CPU,		0,	X_300	},
    {	NULL,	".8x305",	S_CPU,		0,	X_305	},

	/* 8x300 */

    {	NULL,	"move",		S_MOV,		0,	0x0000	},
    {	NULL,	"add",		S_ADD,		0,	0x2000	},
    {	NULL,	"and",		S_AND,		0,	0x4000	},
    {	NULL,	"xor",		S_XOR,		0,	0x6000	},
    {	NULL,	"xec",		S_XEC,		0,	0x8000	},
    {	NULL,	"nzt",		S_NZT,		0,	0xA000	},
    {	NULL,	"xmit",		S_XMT,		0,	0xC000	},
    {	NULL,	"jmp",		S_JMP,		0,	0xE000	},

	/* 8x305 */

    {	NULL,	"xml",		S_XML,		0,	0xCC00	},
    {	NULL,	"xmr",		S_XMR,		0,	0xCD00	},

	/* Defined Instructions */

    {	NULL,	"sel",		S_SEL,		0,	0xC000	},
    {	NULL,	"nop",		S_NOP,		0,	0x0000	},
    {	NULL,	"halt",		S_HLT,		0,	0xE000	},
